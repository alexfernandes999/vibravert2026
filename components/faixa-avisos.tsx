...
export function FaixaAvisos() {
  const fita = (oculto = false) => (
    <ul className="flex shrink-0 items-center" aria-hidden={oculto || undefined}>
      {AVISOS.map((a, i) => (
        <li key={i} className="flex items-center gap-2.5 whitespace-nowrap px-7 text-[12.5px] font-semibold">
  ...
  return (
    <div className="overflow-hidden border-b border-marca/20 bg-marca text-white">
